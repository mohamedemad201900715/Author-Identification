...
<template>
  <body class="AdminHomeBody">
      ...
      <div class="container">
        <ul class="second-nav">
          <div class="tap">
            ...
            <router-link to="/admin_users"><li><a href="">users</a></li> </router-link>
          </div>
          <div class="sear">
            <form class="search">
    ...
    <section class="posts work-steps">
      <div class="container">
        <div class="info">
          <button class="add-btn" @click.prevent="addAuthor"><img src="../assets/add.png" /> Add Author</button>
          <input class="input-auth-name" type="text" placeholder="write author name" v-model="name" />
          <!-- post -->
          <div class="fle" v-if="filteredAuthors.length  > 0">
...
export default {
  ...
  methods: {
    ...
    clickAuthor(idAuthor) {
      this.$router.push({ name: 'authorProfile', params: { id: idAuthor } });
    },
  },
  computed: {
    filteredAuthors() {
