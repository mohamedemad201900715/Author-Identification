...
<template>
  ...
  <body>
      <header class="nav">
          <nav class="container">
              <ul class="L-link">
                  <li style="padding-left:0px;"><a href="" class="Title">Author Identifcation</a></li>
                  <router-link to="/home_admin">    <li><a href="">Home</a></li></router-link>
              </ul>
              <ul class="R-link">
                  <li>
                      ...
                      <div class="image-container">
                          ...
                          <div class="hover-box">
                              <!-- 0 content of box -->
                              <div class="content">
                                 <router-link to="/profile-admin"><a href=""><img src="../assets/profile.png" alt="Your Photo"></a>
